export const skillsByRace = {
  Guerrero: [
    ...
    { id: 2, name: "Tormenta de Espadas", unlockLevel: 5, type: "physical", damage: 150, manaCost: 20, effect: null, effectChance: 0 },
    { id: 3, name: "Furia del Guerrero", unlockLevel: 8, type: "physical", damage: 180, manaCost: 30, effect: "Sangrado", effectChance: 35 },
  ...
  Arquero: [
    ...
    { id: 2, name: "Disparo Preciso", unlockLevel: 4, type: "physical", damage: 120, manaCost: 15, effect: null, effectChance: 0 },
    { id: 3, name: "Ráfaga de Flechas", unlockLevel: 7, type: "physical", damage: 150, manaCost: 30, effect: "Veneno", effectChance: 35 },
    { id: 4, name: "Tiro Fantasma", unlockLevel: 12, type: "physical", damage: 240, manaCost: 45, effect: "Aturdir", effectChance: 20 }
  ]
};
